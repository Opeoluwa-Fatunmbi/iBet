...
from apps.auth_module.models import Jwt, Otp
from apps.core.utils import TestUtil
...
class TestAccounts(APITestCase):
    ...
    def test_register(self):
        ...
        mock.patch("apps.auth_module.emails.Util", new="")
    ...
    def test_refresh_token(self):
        ...
        jwt_obj.save()
        mock.patch("apps.auth_module.auth.Authentication.decode_jwt", return_value=True)
        response = self.client.post(self.refresh_url, {"refresh": jwt_obj.refresh})
        self.assertEqual(response.status_code, 201)
        self.assertEqual(
            response.json(),
